...
The source-citation fixture gate treats semantic retrieval as usable only when every required source is cited at or above the `0.76` threshold; otherwise it requires an exact file-read fallback before answering. The answer-shape gate now adds eleven mocked/static checks (was seven, expanded at `2026-06-09 20:56:46 AEST`, expanded to nine at `2026-06-09 23:50:18 AEST`, expanded to ten at `2026-06-10 00:58 AEST`, expanded to eleven at `2026-06-10 01:51:27 AEST`):
