...
1. Decide `agent_actions` extension vs `crm_activity_timeline` persistence and add route-level event-write tests before wiring lead/contact/opportunity routes to timeline writes.
