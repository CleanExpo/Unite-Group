...
1. Activity/timeline event taxonomy: lead captured, qualified, converted, contact created, opportunity created, approval requested, task completed, integration stale.
