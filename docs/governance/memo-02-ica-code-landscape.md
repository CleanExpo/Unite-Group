# Memo 02 — The ICA Code landscape, and where the field agent stands in it
...
not only on insurers [ICA-04]. The restorer writing the report is inside the instrument.

## What is settled

The redraft is designed to be legally enforceable in consumer insurance contracts for the
...
**The card's premise needs correcting.** The field-agent voice is not absent from the
published Code submission list. Restoration Industry Association Australasia appears by
name [ICA-07]. So do the Association of Insurance Building and Engineering Consultants and
the Australasian Institute of Chartered Loss Adjusters [ICA-08]. The list holds roughly 23
named organisations plus up to 5 anonymised individuals [ICA-08].

What is absent is narrower and more useful: no hygienist body, and no individually named
field practitioner [ICA-08]. Three associations speak for the field. None of them speaks
with field data.

That distinction changes the strategy. The gap is not representation. The gap is evidence.

## The AFCA half of the picture, and its hole
...
2025 produced $4.8 billion in insured extreme-weather losses across 294,000 declared-event
claims [LOSS-01, LOSS-02], more than $4.1 billion of it in Queensland [LOSS-04], at an
...
No contact with ICA, AFCA, ASIC or any consumer body has been made or is proposed. The
consultation window is closed [ICA-02]; there is nothing to submit to even if submitting
were permitted, which it is not.
