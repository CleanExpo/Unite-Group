...
source: "https://cloud.google.com/developers"
author:
published:
created: 2026-05-11
description: "The Google Cloud Developer Center is your source for the latest and greatest developer news and community resources."
tags:
  - "clippings"
---
...
- [
	![Gemini 3.1 Flash Lite](https://www.gstatic.com/bricks/image/a582f240-50a8-4275-a1ed-3bf69673db98.webp)
	Gemini 3.1 Flash Lite
	ANNOUNCEMENT
	Gemini 3.1 Flash-Lite
	Gemini 3.1 Flash-Lite is our fastest and most cost-efficient Gemini 3 series model. Built for high-volume developer workloads at scale, 3.1 Flash-Lite delivers high quality for its price and model tier.
	Gemini 3.1 Flash-Lite is rolling out in preview to developers via the Gemini API in Google AI Studio and for enterprises via Vertex AI.
	](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-flash-lite/)
- [
	![Gen AI Academy, APAC Edition](https://www.gstatic.com/bricks/image/45fd910d-29c9-4b28-be7b-f1948981c48f.jpg)
	Gen AI Academy, APAC Edition
	DEVELOPERS
	Gen AI Academy, APAC Edition | Cohort 2
	192K+ Developers Joined Us to Build. Now, It’s Your Turn.Whether you're a student or a working professional, Gen AI Academy APAC Edition Cohort 2 is built for your next technical leap. Move beyond the basics to master high-impact implementation—from building intelligent multimodal agents to architecting real-time BigQuery data pipelines for production-ready AI.
	](https://vision.hack2skill.com/event/apac-genaiacademy?utm_source=google_developer_centrel&utm_medium=google)
- [
	![Nano Banana 2](https://www.gstatic.com/bricks/image/4aea9fc4-b22c-4e6d-9d61-93ea2c9de294.webp)
	Nano Banana 2
	ANNOUNCEMENT
	Nano Banana 2
	Nano Banana 2 (Gemini 3.1 Flash Image) is our latest state-of-the-art image model. Now you can get the advanced world knowledge, quality and reasoning you love in Nano Banana Pro, at lightning-fast speed.
	Nano Banana 2 is available across Google products, including, Gemini App, AI Studio, Google Cloud and Flow.
	](https://blog.google/innovation-and-ai/technology/ai/nano-banana-2/)

### What do you want to do today?

- [
	![wrench icon](https://www.gstatic.com/bricks/image/f6e36f6d-acfc-449f-9614-53ae884d92bf.svg)
	wrench icon
	Build with Google Cloud
	Your fast track to app development, AI solutions, and quick start resources.
	](https://cloud.google.com/developers#build-with-google-cloud)
- [
	![Graduation cap icon](https://www.gstatic.com/bricks/image/40605b5b-05d7-4f6c-8eb8-8f4001183aa3.svg)
	Graduation cap icon
	Learn with Google Cloud
	Personalized learning to excel in your role. Explore tutorials, videos, and more.
	](https://cloud.google.com/developers#learn-with-google-cloud)
- [
	![Community icon](https://www.gstatic.com/bricks/image/cc1fe817-1082-4dce-8608-be28c9bbc45c.svg)
	Community icon
	Connect with the Community
	Join our active Cloud community, get updates, and connect with our experts.
	](https://cloud.google.com/developers#connect-with-the-cloud-community)
...
- [
	![Gemini CLI](https://www.gstatic.com/bricks/image/e3467f03-096c-41a3-abb1-aa13a74e2f90.png)
	Gemini CLI
	Gemini CLI
	Build, debug, and deploy with AI
	](https://cloud.google.com/artifact-registry/docs/overview)
- [
	![Gemini Code Assist](https://www.gstatic.com/bricks/image/900f2379-a024-441f-a269-8cbbc913dc7c.png)
	Gemini Code Assist
	Gemini Code Assist
	IDE plugin for AI coding assistance
	](https://cloud.google.com/gemini/docs/codeassist/overview)
- [
	![gcloud CLI](https://www.gstatic.com/bricks/image/376e6a66-483b-4101-ad03-71eb70fdc712.png)
	gcloud CLI
	gcloud CLI
	Command-line tooling for Google Cloud
	](https://cloud.google.com/sdk/gcloud)
- [![Cloud Run](https://www.gstatic.com/bricks/image/cafc2cb5-b883-4043-9361-0e0c31490198.png)
	Cloud Run
	Serverless apps and batch jobs
	](https://cloud.google.com/run/docs/overview/what-is-cloud-run)
- [![Vertex AI](https://www.gstatic.com/bricks/image/f8be8674-5a40-4f4a-9939-7d6bfc22d752.png)
	Vertex AI
	Fully-managed AI dev platform
	](https://cloud.google.com/vertex-ai/docs)
- [![Firebase](https://www.gstatic.com/bricks/image/67cdb7a7-94e5-442d-a586-d92ad1373980.png)
	Firebase
...
[![alt](https://www.gstatic.com/bricks/image/79a19a68-be7b-431f-97d4-ea365f9066a2.png)](https://www.youtube.com/user/googlecloudplatform/videos)

[Cloud videos](https://www.youtube.com/user/googlecloudplatform/videos)

[

Master Google Cloud in minutes by watching our bite-sized product videos

](https://www.youtube.com/user/googlecloudplatform/videos)[Tutorials](https://cloud.google.com/docs/tutorials)

[

Deepen your knowledge in under 10 minutes with quick-starts, tutorials, and interactive walkthroughs

](https://cloud.google.com/docs/tutorials)[Google skills](https://www.cloudskillsboost.google/)

[

Get hands-on experience through interactive labs that accelerate your cloud learning

](https://www.cloudskillsboost.google/)[Google Cloud certification](https://cloud.google.com/learn/certification)
...
![Illustration of a code window](https://www.gstatic.com/bricks/image/2add73cb-1abe-407d-8e21-7c6f47acc470.svg)

Illustration of a code window
...
- [
	![decorative image](https://www.gstatic.com/bricks/image/a56bc0a5-2dd3-4d21-aabc-455e50a73af2.png)
	decorative image
	Gemini Enterprise Agent Ready
	Connect and learn how to build and scale AI agents alongside other developers and cloud enthusiasts. Join GEAR to claim 35 monthly learning credits at no cost. Use your credits to access learning resources on Google Skills.
	Join GEAR
	](https://developers.google.com/program/gear/)
- [
	![decorative image](https://www.gstatic.com/bricks/image/3ff2f377-b63d-428f-a6ce-5e7ada15c6b5.png)
	decorative image
	Upcoming events
...
- [
	![decorative image](https://www.gstatic.com/bricks/image/1ff94a73-3523-49a0-9351-7e3800438996.png)
	decorative image
	Community blog
	Read our blog and find inspiration to help accelerate your digital transformation.
	Read community blog
	](https://www.googlecloudcommunity.com/gc/Community-Blogs/bg-p/cloud-community-blog)
