---
title: "Plugins – Codex | OpenAI Developers"
...
Use this when you want to be specific about which plugin or skill Codex should use. See [Codex app commands](https://developers.openai.com/codex/app/commands) and [Skills](https://developers.openai.com/codex/skills).

### How permissions and data sharing work

Installing a plugin makes its workflows available in Codex, but your existing [approval settings](https://developers.openai.com/codex/agent-approvals-security) still apply. Any connected external services remain subject to their own authentication, privacy, and data-sharing policies.
...
If you want to create, test, or distribute your own plugin, see [Build plugins](https://developers.openai.com/codex/plugins/build). That page covers local scaffolding, manual marketplace setup, plugin manifests, and packaging guidance.