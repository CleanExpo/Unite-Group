# Unite-Group (apps/web) — THE product

## Identity (Portfolio SSOT)
**Canonical name:** Unite-Group (package `@unite-group/web`)
**Formerly:** Unite-Hub (repo `CleanExpo/Unite-Hub`, merged into this monorepo 12/06/2026)
**Aliases this app answers to:** "Unite Group", "Unite-Group", "Unite-Group CRM", "the CRM", "Marketing CRM", "Unite-Group Nexus", "Unite-Hub"
**Location:** `apps/web/` of the canonical monorepo `CleanExpo/Unite-Group`
**Registry:** `../../.portfolio/PORTFOLIO.yaml` (monorepo root — the only SSOT; the copy that used to live in this app is gone)

> One repo, one product. The former Authority-Site app was harvested into this
> app (Stripe billing/webhooks, command-center, GitHub/Telegram webhooks) and
> removed — see `../../docs/convergence/migration-map.md`. Do NOT create new
> repos or clones; do NOT write to the former `CleanExpo/Unite-Hub` repo.
