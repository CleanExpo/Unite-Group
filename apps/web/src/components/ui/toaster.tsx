          ...
          >
            ...
            {toast.action && (
              <button
                ...
                className="inline-flex h-8 shrink-0 items-center justify-center rounded-sm border border-white/[0.08] bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-white/[0.04] focus:outline-none focus:ring-2 focus:ring-[#2f9e44]/20 focus:ring-offset-2"
              >
                {toast.action.label}
              </button>
            )}
