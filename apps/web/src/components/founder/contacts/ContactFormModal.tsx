...
export function ContactFormModal({ contact, onClose, onSave }: ContactFormModalProps) {
  ...
  const inputClass =
    'w-full rounded-sm border border-[var(--color-border)] bg-[var(--surface-elevated)] px-3 py-2 text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:border-[#2f9e44] focus:outline-none'
