  ...
  return (
    <div className="flex items-center justify-between gap-4 border border-amber-500/30 bg-amber-500/5 px-4 py-3 rounded-sm">
      ...
      <a
        ...
        className="text-[11px] uppercase tracking-wider text-amber-700 hover:text-amber-700 transition-colors shrink-0 border border-amber-500/40 px-3 py-1 rounded-sm"
      >
        Reconnect →
      </a>
    </div>
