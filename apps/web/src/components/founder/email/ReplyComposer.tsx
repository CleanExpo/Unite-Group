  ...
  return (
    <div className="border-t border-white/[0.06] p-4 space-y-3">
      ...
      <textarea
        ...
        rows={5}
        autoFocus
        className="w-full bg-zinc-900 border border-zinc-700 rounded-sm px-3 py-2 text-sm text-white placeholder-zinc-500 focus:border-[#2f9e44] focus:outline-none resize-none"
      />
      ...
      <div className="flex justify-end">
        <button
          ...
          className="text-xs bg-[#2f9e44] text-black px-4 py-1.5 rounded-sm font-medium hover:opacity-80 disabled:opacity-40 transition-opacity"
        >
