      ...
      <div className="space-y-3">
        <div className="flex items-center gap-3">
          <Switch
            ...
            className="data-[state=checked]:bg-[#2f9e44]"
          />
          ...
          <div className="flex flex-wrap gap-1.5">
            {PIPELINE_OPTIONS.map(p => (
              <button
                ...
                style={{
                  borderColor: pipelineId === p.id ? '#2f9e44' : 'var(--color-border)',
                  background: pipelineId === p.id ? 'rgba(47, 158, 68,0.06)' : 'var(--surface-card)',
                  color: pipelineId === p.id ? '#2f9e44' : 'var(--color-text-muted)',
                }}
                title={p.hint}
              >
                {p.icon}
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] uppercase tracking-widest" style={{ color: 'rgba(47, 158, 68,0.6)' }}>
                Strategic Analysis
              </span>
            </div>
            <div className="text-[13px] leading-relaxed whitespace-pre-wrap"
