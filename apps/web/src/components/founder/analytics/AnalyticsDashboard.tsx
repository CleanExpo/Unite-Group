...
function StatCard({ label, value, index }: StatCardProps) {
  return (
    ...
    >
      ...
      <span className="text-[26px] font-semibold leading-none tracking-tight text-[#2f9e44]">
        {value}
      </span>
    </motion.div>
  )
    ...
    <div className="flex flex-col gap-6">
        ...
        >
          {DATE_RANGE_OPTIONS.map(({ value, label }) => (
            <button
              ...
              style={{
                background: dateRange === value ? 'rgba(47, 158, 68,0.12)' : 'transparent',
                color: dateRange === value ? '#2f9e44' : 'var(--color-text-muted)',
      ...
      {!loading && analytics.length === 0 && (
        <motion.div
          ...
          style={{ border: '1px dashed #2f9e4433' }}
        >
              ...
              {platformRows.map(([platform, stats]) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 font-medium text-[#2f9e44]">{engRate}%</td>
                  </motion.tr>
                )
              })}
            </motion.tbody>
            ...
            >
              {topPosts.map((post) => (
                ...
                >
                  ...
                  <td className="px-4 py-2.5 font-medium text-[#2f9e44]">
