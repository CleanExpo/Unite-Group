...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; border: string }> = {
  auto_matched:    { label: 'Auto',       color: '#16a34a', bg: 'rgba(22, 163, 74,0.08)', border: 'rgba(22, 163, 74,0.2)' },
  ...
  reconciled:      { label: 'Reconciled', color: '#16a34a', bg: 'rgba(22, 163, 74,0.12)', border: 'rgba(22, 163, 74,0.3)' },
}
