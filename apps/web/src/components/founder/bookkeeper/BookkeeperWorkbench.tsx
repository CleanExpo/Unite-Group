          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                style={{ color: isActive ? 'var(--mission-blue)' : undefined }}
              >
                <span
                  className={
                    isActive
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 right-0 h-[2px] bg-[var(--mission-blue)]"
                    style={{ boxShadow: '0 2px 4px color-mix(in srgb, var(--mission-blue) 30%, transparent)' }}
