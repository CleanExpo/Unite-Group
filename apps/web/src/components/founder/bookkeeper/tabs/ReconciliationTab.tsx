        ...
        <AnimatePresence>
          {selected.size > 0 && (
            <motion.button
              ...
              style={{
                borderColor: 'rgba(47, 158, 68,0.3)',
                color: '#2f9e44',
                backgroundColor: 'rgba(47, 158, 68,0.06)',
              }}
            >
        ...
        <div className="flex items-center gap-2">
          <div className="w-16 h-1.5 rounded-sm bg-white/10 overflow-hidden">
            <div
              ...
              style={{ width: `${confidence}%`, backgroundColor: '#2f9e44' }}
            />
          </div>
      ...
      <td className="px-3 py-2.5 text-right whitespace-nowrap">
        <div className="flex items-center justify-end gap-1.5">
          {isReconcilable && (
            <button
              onClick={onReconcile}
              className="text-[11px] px-2 py-0.5 rounded-sm border hover:border-[#2f9e44]/40 transition-colors"
              style={{ borderColor: 'var(--color-border)', color: '#2f9e44' }}
            >
              Reconcile
            </button>
          )}
