      ...
      >
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-sm px-3 py-2 text-[13px] focus:outline-none focus:border-[#2f9e44]/30"
        ...
        <div
          ...
          style={{ border: '1px solid', borderColor: showAI ? 'rgba(47, 158, 68, 0.25)' : 'var(--color-border)' }}
        >
          <button
            onClick={() => setShowAI(!showAI)}
            className="w-full flex items-center justify-between px-3 py-2 text-[10px] uppercase tracking-wider transition-colors"
            style={{
              background: showAI ? 'rgba(47, 158, 68, 0.05)' : 'var(--surface-card)',
              color: showAI ? '#2f9e44' : 'var(--color-text-secondary)',
            }}
          >
            ...
            <div className="px-3 py-3 space-y-3" style={{ background: 'var(--surface-card)' }}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-sm px-3 py-1.5 text-[12px] placeholder:text-white/40 focus:outline-none focus:border-[#2f9e44]/30"
                  style={{ background: 'var(--surface-elevated)', borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border)', color: 'var(--color-text-primary)' }}
                />
              </div>
                  ...
                  {CHARACTER_OPTIONS.map(c => (
                    <button
                      ...
                      className={`flex-1 px-2 py-1.5 text-[10px] rounded-sm border transition-colors ${
                        aiCharacter === c.key
                          ? 'border-[#2f9e44]/40 text-[#2f9e44] bg-[#2f9e44]/5'
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-sm px-3 py-1.5 text-[12px] focus:outline-none focus:border-[#2f9e44]/30"
                  style={{ background: 'var(--surface-elevated)', borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border)', color: 'var(--color-text-primary)' }}
                >
              ...
              <button
                ...
                style={{
                  background: generating ? 'rgba(47, 158, 68, 0.1)' : 'linear-gradient(135deg, #2f9e44, #00C4CC)',
                  color: generating ? '#2f9e44' : '#050505',
                  boxShadow: generating ? 'none' : '0 0 20px rgba(47, 158, 68, 0.15)',
                  fontWeight: 600,
                }}
              >
                {generating ? (
                  <span className="inline-flex items-center gap-2">
                    <span className="inline-block w-3 h-3 rounded-sm border-2 border-[#2f9e44]/30 border-t-[#2f9e44] animate-spin" />
                    Generating...
                  </span>
                ) : (
                  'Generate'
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {variants.map((v, i) => (
                    <button
                      ...
                      className="w-full text-left rounded-sm px-3 py-2.5 transition-all hover:border-[#2f9e44]/40 group"
                      style={{
                      ...
                      onMouseEnter={e => {
                        (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(47, 158, 68, 0.4)'
                        ;(e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 12px rgba(47, 158, 68, 0.08)'
                      }}
                      onMouseLeave={e => {
                    ...
                    >
                      ...
                      {v.hashtags.length > 0 && (
                        <p className="text-[10px] mt-1 opacity-80" style={{ color: '#2f9e44' }}>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-sm px-3 py-2 text-[13px] placeholder:text-white/40 focus:outline-none focus:border-[#2f9e44]/30 resize-none"
            style={{ background: 'var(--surface-elevated)', borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--color-border)', color: 'var(--color-text-primary)' }}
          />
        ...
        <div className="flex gap-2 pt-2">
          ...
          {scheduledAt ? (
            <button
              ...
              disabled={saving}
              className="px-4 py-2 text-[10px] uppercase tracking-wider text-[#2f9e44] border border-[#2f9e44]/30 rounded-sm hover:bg-[#2f9e44]/5 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-4 py-2 text-[10px] uppercase tracking-wider text-[#050505] bg-[#2f9e44] rounded-sm hover:bg-[#2f9e44]/90 transition-colors disabled:opacity-50"
            >
