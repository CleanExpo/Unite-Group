...
const ROLE_ICONS: Record<string, React.ReactNode> = {
  'ai-agent':  <Zap size={13} style={{ color: '#2f9e44' }} />,
  'developer': <Code2 size={13} style={{ color: '#f59f00' }} />,
...
export function TeamPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="rounded-sm border p-4 space-y-3" style={{ borderColor: 'rgba(47, 158, 68,0.2)', background: 'var(--surface-card)' }}>
        ...
        {members.map((m) => {
          ...
          return (
            <div
              ...
              style={{
                borderColor: isAI ? 'rgba(47, 158, 68,0.3)' : 'var(--color-border)',
