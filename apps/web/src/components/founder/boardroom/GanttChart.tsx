    ...
    <div id="gantt-container" className="w-full overflow-x-auto" style={{ scrollbarWidth: 'thin' }}>
      <div className="flex" style={{ minWidth: LABEL_W + chartW + 32 }}>
        ...
        <svg width={chartW} height={svgHeight} style={{ flexShrink: 0 }}>
          ...
          {/* Today line */}
          <line x1={todayX} y1={0} x2={todayX} y2={svgHeight} stroke="#16a34a" strokeWidth={1.5} />
          <text x={todayX + 3} y={14} fontSize={9} fill="#16a34a" fontWeight="600">TODAY</text>
        </svg>
      </div>
      ...
      <div className="flex items-center gap-4 mt-3 px-2 flex-wrap">
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-3 rounded-sm border" style={{ background: 'rgba(22, 163, 74,0.2)', borderColor: '#16a34a' }} />
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-0.5 h-3" style={{ background: '#16a34a' }} />
