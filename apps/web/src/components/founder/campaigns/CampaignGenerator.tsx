    ...
    <div className="bg-[#0a0a0a] border border-white/[0.06] rounded-sm p-6 space-y-6">
      ...
      {uiState === 'config' && (
        <div className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            >
              Theme <span style={{ color: '#2f9e44' }}>*</span>
            </label>
            <input
              type="text"
              value={theme}
          ...
          <div className="space-y-2">
            <label
              ...
              style={{ color: 'rgba(255,255,255,0.35)' }}
            >
              Platforms <span style={{ color: '#2f9e44' }}>*</span>
            </label>
              ...
              {PLATFORMS.map((platform) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: checked ? 'rgba(47, 158, 68,0.08)' : 'rgba(255,255,255,0.03)',
                      borderColor: checked ? 'rgba(47, 158, 68,0.35)' : 'rgba(255,255,255,0.08)',
                      color: checked ? '#2f9e44' : 'rgba(255,255,255,0.45)',
                    }}
                  >
                    {/* Custom checkbox dot */}
                    <span
                      ...
                      style={{
                        background: checked ? '#2f9e44' : 'transparent',
                        borderColor: checked ? '#2f9e44' : 'rgba(255,255,255,0.2)',
                      }}
                    >
                      {checked && (
                        <svg
          ...
          <div className="pt-1">
            <button
              ...
              disabled={!canSubmit}
              className="bg-[#2f9e44] text-black font-medium rounded-sm px-6 py-2.5 text-[13px] transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Generate Campaign
            </button>
            {!canSubmit && (
      ...
      {uiState === 'generating' && (
        <div className="flex flex-col items-center justify-center py-16 gap-4">
          <Loader2 size={28} className="animate-spin" style={{ color: '#2f9e44' }} />
      ...
      {uiState === 'complete' && generateResult && (
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            <CheckCircle2 size={16} style={{ color: '#2f9e44' }} />
          ...
          <div
            ...
            style={{
              ...
              borderColor: 'rgba(47, 158, 68,0.15)',
            }}
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-1 text-center">
                <p className="text-[22px] font-semibold tabular-nums" style={{ color: '#2f9e44' }}>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-[#2f9e44] text-black font-medium rounded-sm px-6 py-2.5 text-[13px] transition-opacity"
            >
              View Campaign
            </button>
            <button
