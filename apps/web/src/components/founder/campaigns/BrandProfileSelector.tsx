      ...
      {loadState === "empty" && (
        <div className="rounded-sm border border-white/[0.06] bg-white/[0.02] px-4 py-5 flex flex-col gap-3">
          ...
          <button
            type="button"
            onClick={onScanNew}
            className="self-start bg-[#2f9e44] text-black text-[12px] font-semibold rounded-sm px-4 py-2 hover:bg-[#2f9e44]/90 transition-colors"
          >
            Scan Brand DNA
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {profiles.map((profile) => (
            <button
              ...
              className="text-left rounded-sm border border-white/[0.08] bg-white/[0.02] hover:border-[#2f9e44]/40 hover:bg-[#2f9e44]/[0.04] px-4 py-3 transition-colors"
            >
