        ...
        <>
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 h-12 border-b shrink-0"
              ...
              <Zap size={14} style={{ color: '#2f9e44' }} />
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  ...
                  {messages.map((msg, i) => (
                    <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                      <div
                        ...
                        style={{
                          background: msg.role === 'user' ? 'rgba(47, 158, 68,0.08)' : 'var(--surface-card)',
                          color: 'var(--color-text-primary)',
              ...
              {state === 'spec' && spec && (
                <div className="space-y-3">
                  <p className="text-[11px] uppercase tracking-widest" style={{ color: '#2f9e44' }}>
                    Ready to create
                  </p>
                      ...
                      <ul className="space-y-1 list-none">
                        {spec.acceptanceCriteria.map((c, i) => (
                          <li key={i} className="flex gap-2" style={{ color: 'var(--color-text-secondary)' }}>
                            <span style={{ color: '#2f9e44' }}>✓</span> {c}
                          </li>
                        ))}
                      </ul>
                    )}
