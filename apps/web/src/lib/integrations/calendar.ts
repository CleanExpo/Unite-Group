...
export function getMockEvents(): CalendarEvent[] {
  const now = new Date()
  return [
    { id: '1', title: 'Synthex Client Call', start: now.toISOString(), end: new Date(now.getTime() + 3600000).toISOString(), businessKey: 'synthex', colour: '#16a34a', email: 'support@synthex.social' },
