...
vi.mock('@/lib/coaches/life', () => ({ fetchLifeData: vi.fn() }))
vi.mock('@/lib/coaches/prompts/life', () => ({
  LIFE_COACH_SYSTEM_PROMPT: 'sys',
  buildLifeUserMessage: vi.fn().mockReturnValue('msg'),
}))
...
describe('GET /api/cron/coaches/life', () => {
