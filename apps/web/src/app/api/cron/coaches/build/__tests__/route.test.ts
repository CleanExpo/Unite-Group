...
vi.mock('@/lib/coaches/build', () => ({ fetchBuildData: vi.fn() }))
vi.mock('@/lib/coaches/prompts/build', () => ({
  BUILD_COACH_SYSTEM_PROMPT: 'sys',
  buildBuildUserMessage: vi.fn().mockReturnValue('msg'),
}))
...
describe('GET /api/cron/coaches/build', () => {
