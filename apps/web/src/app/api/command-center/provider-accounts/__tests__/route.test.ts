...
function patchReq(body: unknown) {
  return new Request('https://app.test/api/command-center/provider-accounts', {
    method: 'PATCH',
...
describe('PATCH /api/command-center/provider-accounts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
...
describe('DELETE /api/command-center/provider-accounts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.mocked(createClient).mockResolvedValue({} as never)
  })
