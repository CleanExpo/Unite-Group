// End-to-end contract test for POST /api/command-centre/control-panel/add-ons.
//
...
function makeReq(body: unknown): Request {
  return new Request('http://localhost/api/command-centre/control-panel/add-ons', {
    method: 'POST',
...
describe('POST /api/command-centre/control-panel/add-ons — happy path', () => {
  beforeEach(() => {
    vi.clearAllMocks()
