      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <Section title="1. Overview">
          <p>
            ...
            <a href={APP_URL} style={{ color: '#2f9e44' }}>{APP_URL}</a>. This Privacy Policy explains
        ...
        <Section title="4. Google API Scopes">
          <p>
            ...
            <a href="https://developers.google.com/terms/api-services-user-data-policy" style={{ color: '#2f9e44' }}>
        ...
        <Section title="7. Your Rights">
          ...
          <ul>
            ...
            <li>Lodge a complaint with the Office of the Australian Information Commissioner (OAIC) at <a href="https://www.oaic.gov.au" style={{ color: '#2f9e44' }}>oaic.gov.au</a></li>
          </ul>
          <p>
