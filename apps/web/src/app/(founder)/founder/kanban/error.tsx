...
// src/app/(founder)/founder/kanban/error.tsx
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <h2 className="text-lg font-semibold">Kanban unavailable</h2>
        <p className="text-sm max-w-sm" style={{ color: 'var(--color-text-muted)' }}>
          Linear connection may have expired — check your API key in settings to restore board access.
        </p>
      </div>
