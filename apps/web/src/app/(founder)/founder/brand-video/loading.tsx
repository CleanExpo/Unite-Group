export default function Loading() {
  return (
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="bg-[#fff7ec] border border-white/[0.06] rounded-sm p-4 flex flex-col gap-4">
        <div className="h-2 w-32 bg-white/[0.06] rounded-sm animate-pulse" />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[0, 1, 2].map((i) => (
            <div key={i} className="h-24 bg-white/[0.03] rounded-sm animate-pulse" />
          ))}
        </div>
        <div className="h-9 w-40 bg-white/[0.06] rounded-sm animate-pulse" />
      </div>
      <div className="bg-[#fff7ec] border border-white/[0.06] rounded-sm p-4">
        ...
        <div className="h-[240px] bg-white/[0.03] rounded-sm animate-pulse" />
      </div>
    </div>
  )
}
