      ...
      <div className="flex gap-4" style={{ height: 'calc(100vh - 200px)' }}>
        <div className="w-80 flex-shrink-0 flex flex-col gap-2">
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div key={i} className="bg-[#fff7ec] border border-white/[0.06] rounded-sm px-3 py-3 flex flex-col gap-2">
        ...
        <div className="flex-1 bg-[#fff7ec] border border-white/[0.06] rounded-sm p-6 flex flex-col gap-4">
