...
// palette source for the Mission Control restyle. FounderShell defines
// --font-inter on the same element as .missionTheme, so the sidebar and every
// command-centre route are in scope.
