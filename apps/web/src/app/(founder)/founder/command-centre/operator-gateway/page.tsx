    ...
    <div style={wrap}>
      ...
      <section style={card} aria-label="mobile voice intake">
        ...
        <div style={grid}>
          ...
          <p>Source note writing enabled: {boolLabel(view.mobileVoiceIntake.sourceNoteWriteEnabled, false)}</p>
          <p>Board packet generation enabled: {boolLabel(view.mobileVoiceIntake.boardPacketGenerationEnabled, false)}</p>
