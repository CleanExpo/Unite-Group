# Agent setup for `Unite-Group`

This is a deepsec scanning workspace. Project `Unite-Group` was just registered
(target: `..`). Setup is incomplete — `data/Unite-Group/INFO.md`
...
2. **Fill in `data/Unite-Group/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id Unite-Group
pnpm deepsec process --project-id Unite-Group
```
