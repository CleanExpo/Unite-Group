...
export default function ContentArtefacts() {
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center gap-6 text-white">
      <h1 className="text-3xl font-bold">Content Artefacts</h1>
      <p className="text-slate-400 text-center max-w-sm">
        Produced content across all 6 businesses will be catalogued here.
      </p>
      <Link
        href="/dashboard/ceo"
