    ...
    return (
      <div style={{ minHeight: "100vh", background: "#09090b", padding: 32, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ maxWidth: 480, background: "#111113", border: "1px solid #27272a", borderRadius: 12, padding: 40, textAlign: "center" }}>
          ...
          <Link href="/en/dashboard" style={{ background: "#1d4ed8", color: "#fff", textDecoration: "none", padding: "8px 20px", borderRadius: 8, fontSize: 13, fontWeight: 500 }}>
            Back to Dashboard
          </Link>
        </div>
      </div>
      ...
      <div style={{ borderBottom: "1px solid #27272a", background: "rgba(9,9,11,0.9)", backdropFilter: "blur(20px)", position: "sticky", top: 0, zIndex: 50 }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <Button variant="ghost" size="sm" style={{ color: "#a1a1aa" }} onClick={() => router.push('/en/dashboard')}>
